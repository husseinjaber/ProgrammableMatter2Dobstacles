/*
 * @file world.h
 * @brief Description of the simulated environment
 *
 ...
 */
    ...
    public:
        ...
        /**
         * @brief Returns a boolean indicating if a block can be added to face #numSelectedFace of block identified by #numSelectedGlBlock
         *
